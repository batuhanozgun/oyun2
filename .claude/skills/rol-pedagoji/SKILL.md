---
description: Pedagoji zemini rolü oturum açılış töreni. Yalnız insan /rol-pedagoji ile tetikler; ajan kendiliğinden tetikleyemez (bilinçli kilit).
disable-model-invocation: true
---

!`bash "${CLAUDE_PROJECT_DIR:-.}/tools/guard/rol-ac.sh" pedagoji tam`

# Rol töreni — Pedagoji zemini
...
1. `03_roller/pedagoji/ROL.md` oku — rol sözleşmen budur (tek ev; burada kopyası yok).
2. `03_roller/pedagoji/DURUM.md` oku — kaldığın yer.
...
4. Sözleşmedeki yetki sınırı oturum boyu geçerli; mod **tam**dır (yazamaz = dosya-yazma
   araçların kancayla mekanik kilitli; kendi `03_roller/pedagoji/` klasörün hariç, ROL.md
