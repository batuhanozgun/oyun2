---
description: Çocuk güvenliği ve uyum rolü oturum açılış töreni. Yalnız insan /rol-guvenlik ile tetikler; ajan kendiliğinden tetikleyemez (bilinçli kilit).
disable-model-invocation: true
---

!`bash "${CLAUDE_PROJECT_DIR:-.}/tools/guard/rol-ac.sh" guvenlik tam`

# Rol töreni — Çocuk güvenliği ve uyum
...
1. `03_roller/guvenlik/ROL.md` oku — rol sözleşmen budur (tek ev; burada kopyası yok).
2. `03_roller/guvenlik/DURUM.md` oku — kaldığın yer.
...
4. Sözleşmedeki yetki sınırı oturum boyu geçerli; mod **tam**dır (yazamaz = dosya-yazma
   araçların kancayla mekanik kilitli; kendi `03_roller/guvenlik/` klasörün hariç, ROL.md
