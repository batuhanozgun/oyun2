---
description: İçerik yazarı rolü oturum açılış töreni. Yalnız insan /rol-icerik ile tetikler; ajan kendiliğinden tetikleyemez (bilinçli kilit).
disable-model-invocation: true
---

!`bash "${CLAUDE_PROJECT_DIR:-.}/tools/guard/rol-ac.sh" icerik tam`

# Rol töreni — İçerik yazarı
...
1. `03_roller/icerik/ROL.md` oku — rol sözleşmen budur (tek ev; burada kopyası yok).
2. `03_roller/icerik/DURUM.md` oku — kaldığın yer.
...
4. Sözleşmedeki yetki sınırı oturum boyu geçerli; mod **tam**dır (yazamaz = dosya-yazma
   araçların kancayla mekanik kilitli; kendi `03_roller/icerik/` klasörün hariç, ROL.md
