---
description: Denetçi rolü oturum açılış töreni. Yalnız insan /rol-denetci ile tetikler; ajan kendiliğinden tetikleyemez (bilinçli kilit).
disable-model-invocation: true
---

!`bash "${CLAUDE_PROJECT_DIR:-.}/tools/guard/rol-ac.sh" denetci yazamaz`
...
1. `03_roller/denetci/ROL.md` oku — rol sözleşmen budur (tek ev; burada kopyası yok).
2. `03_roller/denetci/DURUM.md` oku — kaldığın yer.
...
4. Sözleşmedeki yetki sınırı oturum boyu geçerli; mod **yazamaz**dır (yazamaz = dosya-yazma
   araçların kancayla mekanik kilitli; kendi `03_roller/denetci/` klasörün hariç, ROL.md
