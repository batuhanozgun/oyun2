---
description: Geliştirici rolü oturum açılış töreni. Yalnız insan /rol-gelistirici ile tetikler; ajan kendiliğinden tetikleyemez (bilinçli kilit).
disable-model-invocation: true
---

!`bash "${CLAUDE_PROJECT_DIR:-.}/tools/guard/rol-ac.sh" gelistirici tam`

# Rol töreni — Geliştirici
...
1. `03_roller/gelistirici/ROL.md` oku — rol sözleşmen budur (tek ev; burada kopyası yok).
2. `03_roller/gelistirici/DURUM.md` oku — kaldığın yer.
...
4. Sözleşmedeki yetki sınırı oturum boyu geçerli; mod **tam**dır (yazamaz = dosya-yazma
   araçların kancayla mekanik kilitli; kendi `03_roller/gelistirici/` klasörün hariç, ROL.md
