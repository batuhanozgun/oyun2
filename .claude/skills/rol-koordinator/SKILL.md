---
description: Koordinatör rolü oturum açılış töreni. Yalnız insan /rol-koordinator ile tetikler; ajan kendiliğinden tetikleyemez (bilinçli kilit).
disable-model-invocation: true
---

!`bash "${CLAUDE_PROJECT_DIR:-.}/tools/guard/rol-ac.sh" koordinator tam`

# Rol töreni — Koordinatör
...
1. `03_roller/koordinator/ROL.md` oku — rol sözleşmen budur (tek ev; burada kopyası yok).
2. `03_roller/koordinator/DURUM.md` oku — kaldığın yer.
...
4. Sözleşmedeki yetki sınırı oturum boyu geçerli; mod **tam**dır (yazamaz = dosya-yazma
   araçların kancayla mekanik kilitli; kendi `03_roller/koordinator/` klasörün hariç, ROL.md
